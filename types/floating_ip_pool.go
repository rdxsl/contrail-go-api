...
const (
	...
	floating_ip_pool_virtual_network_back_refs
...
func (obj *FloatingIpPool) addChange(
...
func (obj *FloatingIpPool) readVirtualNetworkBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid&floating_ip_pool_virtual_network_back_refs == 0) {
...
func (obj *FloatingIpPool) GetVirtualNetworkBackRefs() (
	contrail.ReferenceList, error) {
...
func (obj *FloatingIpPool) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "virtual_network_back_refs":
			...
			if err == nil {
				obj.valid |= floating_ip_pool_virtual_network_back_refs
			}
			break
