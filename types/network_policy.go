...
const (
	...
	network_policy_project_back_refs
...
func (obj *NetworkPolicy) addChange(
...
func (obj *NetworkPolicy) readProjectBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid&network_policy_project_back_refs == 0) {
...
func (obj *NetworkPolicy) GetProjectBackRefs() (
...
func (obj *NetworkPolicy) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "project_back_refs":
			...
			if err == nil {
				obj.valid |= network_policy_project_back_refs
			}
			break
